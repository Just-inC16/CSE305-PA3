	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">History of all auctions participated
							in</h5>
						<div class="container">
					...
					<div class="card-body">
						...
						<div class="container">
							<form action="getBestsellersForCustomer">
								<input type="submit" value="View Best Sellers"
									class="btn btn-success" />
							</form>
						</div>
					</div>
					...
					<div class="card-body">
						...
						<div class="container">
							<form action="personalizedSuggestions">
								<input type="submit" value="View Personalized Suggestions"
									class="btn btn-success" />
							</form>
						</div>
					</div>
