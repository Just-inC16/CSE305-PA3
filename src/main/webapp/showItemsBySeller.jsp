							...
							<td>
								<form method="POST" action="bidInAuction">
									<div class="form-group">
										<input type="hidden" class="form-control" name="auctionID"
											value=${auctions[loop.index].auctionID}> <input
											type="hidden" class="form-control" name="itemID"
											value=${items[loop.index].itemID}>
									</div>
